...
OBJECTS = loader.o kmain.o shell.o process.o scheduler.o syscall.o malloc.o paging.o kheap.o memory.o ata_pio.o gdt.o gdt_asm.o timer.o keyboard.o irq.o irq_asm.o isr.o isr_asm.o idt.o idt_asm.o logging.o printer.o string.o io.o math.o queue.o list.o utils.o
